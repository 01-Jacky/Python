...
soup = parser.loadSoup("https://www.linkedin.com/feed/")
print(soup.prettify())

with open('tmp_html','w') as f:
    f.write(soup.prettify('UTF-8'))

# soup = parser.loadSoup("https://www.linkedin.com/jobs/search/?keywords=SOFTWARE%20INTERN&location=United%20States&locationId=us%3A0")
# print(soup.prettify())